...
<!-- Begin Page Content -->
                <div class="container-fluid">
						...
						<form method="POST">
                            <div class="form-group row">                                
								...
								<div class="col-auto text-center d-none d-sm-inline-block">
                                    ...
                                    <div class="form-group row">
										<div class="col-xs-6 ml-2">
											<input class="btn btn-primary btn-user btn-block bg-gradient-primary text-center" name="submit" type="submit" value="Submit" formaction="dailypost.php">
										</div> &nbsp
									</div>
								</div>
								...
								<div class="col-sm-3 text-center d-md-none">
                                    <label class="invisible">.</label>
									<input class="btn btn-primary btn-user btn-block bg-gradient-primary text-center" type="submit" name="submit" value="Submit" formaction="dailypost.php"> 
									<input class="btn btn-danger btn-user btn-block bg-gradient-danger text-center" type="submit" value="Clear" formaction="dailypost.php">
								</div>
                            </div>
						</form>
					</div>
                    ...
                    <div class="row">
						...
						<?php 
							...
							WHERE userid = '$userid' AND datefromto BETWEEN '$backfrom' AND '$backto' AND M_timein != ''";
							$query3=$HRconnect->query($sql3);
							$row3=$query3->fetch_array();

							$sql4="SELECT SUM(time_to_sec(TIMEDIFF(A_timeout, M_timein))) as totalhours FROM sched_time
							WHERE userid = '$userid' AND datefromto BETWEEN '$backfrom' AND '$backto' AND M_timein != '' AND A_timeout != ''";
                            ...
                            WHERE userid = '$userid' BETWEEN '$backfrom' AND '$backto' AND M_timein != '' AND M_timeout != '' AND A_timein = '' AND A_timeout = ''";
							...
							WHERE userid = '$userid' AND overunder.otdatefrom BETWEEN '$backfrom' AND '$backto' AND overunder.otstatus = 'approved'";
							$query7=$HRconnect->query($sql7);
							$row7=$query7->fetch_array();

							$sql5="SELECT SUM(break) as totalbreak FROM sched_time
							WHERE userid = '$userid' AND datefromto BETWEEN '$backfrom' AND '$backto' AND M_timein != '' AND A_timeout != 'No Break' AND M_timeout != 'No Break' AND A_timeout != '' AND break = 1";
							$query5=$HRconnect->query($sql5);
							$row5=$query5->fetch_array();

							$sql6="SELECT COUNT(*) as nobreak FROM sched_time
							WHERE userid = '$userid' AND datefromto BETWEEN '$backfrom' AND '$backto' AND M_timein != '' AND (A_timeout = 'No Break' OR M_timeout = 'No Break') AND A_timeout != ''";
 ...
 $sql1 = "SELECT * FROM sched_time where datefromto BETWEEN '$backfrom' AND '$backto' AND status != 'deleted'  AND userid = '$userid'";
