...
header('Location:employeelist.php?active=active');
...
<!-- Begin Page Content -->
            ...
            <!-- Active -->        
				...
				<ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="effect-shine nav-link active" href="employeelist.php?active=active"><b>Active</b></a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="effect-shine nav-link" href="employeelist2.php?inactive=inactive"><b>Inactive</b></a>
                            </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered table-hover text-uppercase" id="example" width="100%" cellspacing="0">
									...
									<?php
										...
										if ($empno == 3075) {
										$sql = "SELECT * FROM user_info where status = 'active'
                                        AND empno in (2234,2550,2559,3075,4071,4139,5700,5701)
										";
										}
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-tasks" aria-hidden="true"></i> Employee Details <b class="d-none"><?php echo $row['empno']; ?></b> </h5>
 ...
 <div class="modal-body">
            ...
            <div class="text-center">
                <h1 class="h5 text-gray-900 mb-sm-0">
            </div>
