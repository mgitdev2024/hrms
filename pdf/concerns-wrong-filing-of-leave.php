            ...
            <div class="form-group mb-1" style="text-align: left;">
                <div class="table-responsive">
                    <table class="table table-bordered rounded-">
                        <thead>
                            <tr>
                                <th>Current Total Leave</th>
                                <th>Total Filed Leave</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><input class="form-control bg-gray-100 text-center text-uppercase" type="text" id="currentTotalLeave" name="currentTotalLeave" readonly></td>
                                <td><input class="form-control bg-gray-100 text-center text-uppercase" type="text" id="filedLeave" name="filedLeave" readonly></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
