...
<div class="container-fluid">
			...
			<form class="user" method="post" action="../update.php?dtr=dtr2">
...
if (($datefromto == '2022-05-09')  AND $mtimein1 != '' AND $atimeout1 != '' AND ($datefrom2 <= $mtimein1 AND $dateto2 >= $atimeout1)){
...
}elseif (($datefromto == '2022-05-09') AND $mtimein1 != '' AND $atimeout1 != '' AND $datefrom2 >= $mtimein1 AND $dateto2 <= $atimeout1){
