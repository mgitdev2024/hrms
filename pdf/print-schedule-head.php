<?php
$user_info_query = "SELECT branch, name, position, picture FROM `hrms`.`user_info` WHERE empno = ?";
$stmt = $HRconnect->prepare($user_info_query);
