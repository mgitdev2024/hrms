...
if(@$statusall == 0){
	...
	if(($mtimein != '' AND $mtimeout != '' AND $atimein != '' AND $atimeout != '') AND @$statusall == 0){
if (($datefromto == '2022-08-21')  AND $mtimein != '' AND $atimeout != '' AND ($datefrom <= $mtimein AND $dateto >= $atimeout)){
	
	@$spcregday1 = floor((strtotime($atimeout) - strtotime($datefrom))/3600) - $break;

}elseif (($datefromto == '2022-08-21') AND $mtimein != '' AND $atimeout != '' AND $datefrom >= $mtimein AND $dateto <= $atimeout){
...
//kapag ang time inputs gabi hanang umaga at tuamam sa 10:00pm to 06:00am ND
...
?>
			...
			<?php 
				...
				}elseif(@$row15['status'] == 'Approved'){ echo "<i class='text-success'>"."OBP " .@$row15['status']. "</i>"; } ?> </center></td>
				</tr>
			<?php 
					}
				?>
...
<?php
		...
		?>
				...
				<tr class="table-secondary text-uppercase"> 									
					...
					<td colspan="1"><center>Leave</center></td>
...
if(@$_GET['backtrack'] != 'backtrack'){
				...
				<tr>
					...
					<td colspan="1"><center><b><?php echo $row10['vl']; ?></b></center></td>
...
$sqlo="SELECT * FROM generated
	...
	<tr>
					...
					<td colspan="1"><center><b>0</b></center></td>
					<td><center><b>0</b></center></td>
					<td><center><b>0</b></center></td>
				</tr>
	...
	<tr>
					...
					<td colspan="1"><center><b><?php echo $rowo['vleave']; ?></b></center></td>
			...
			<?php } 
				...
				<tr>
					<td colspan="11" ><b class="invisible">.</b></td>
				</tr>
