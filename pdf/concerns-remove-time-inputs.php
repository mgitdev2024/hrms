...
<div class="responsive-container">
    ...
    <div class="box">
        <div id="">
            <div class="form-group mb-1" style="text-align: left;">
                ...
                <div class="table-responsive mb-0">
                    <table class="table table-bordered rounded-">
                        <thead>
                            <tr>
                                <th>Broken Sched Time In</th>
                                <th>Broken Sched Time Out</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
            ...
            <div class="form-group mb-1" style="text-align: left;">
                <label for="" class="mb-1" style="font-weight: bold; margin-right: 10px;">Requested To Remove:</label>
                <div class="table-responsive">
                    <table class="table table-bordered rounded-">
                        ...
                        <tbody>
                            <tr>
                                <td><input class="form-control bg-gray-100 text-center text-uppercase" type="text" id="removeTimeInputs" name="removeTimeInputs" readonly></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
