...
@$grandgen = @$gentotal;
		...
		if($mtimeout1 != '' AND $atimeout1 != '' AND @$row11['ottype'] == 'Undertime' AND @$row11['otstatus'] == 'approved'){
...
{	
    ...
    $sqldp1 = "SELECT * FROM sched_time 
            ...
            WHERE mothercafe not in(4,109,102,103,139) AND sched_time.empno = '$empno' AND (datefromto between '$datefrom' AND '$dateto') ";
...
<?php
							...
							if(@$daterow22['idgen'] == 0 AND $mothercafe != '88'){
							?>
