					...
					<table class="myTable table-hover" id="example" width="100%" cellspacing="0">
						...
						<thead class="table-secondary text-uppercase">
							<tr>
								...
								<th><center>A.Leave</center></th>
								<th><center>R.Leave</center></th>
						...
						<?php
							...
							$sql1="SELECT DISTINCT empno FROM vlform 
							WHERE vlstatus = 'approved' AND vldatefrom between '$datefrom' AND '$dateto'";
