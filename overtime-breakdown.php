	...
	<?php include("navigation.php"); ?>
                ...
                <div class="container-fluid">
					<div class="d-sm-flex align-items-center justify-content-between mb-2">
						<div class="mb-1">
							<h4 class="mb-0">Cut-off Details - Overtime</h4>
							<div>
								<a href="discrepancy.php"><span class="text-secondary fw-500">List</span></a>
								/ 
									...
									<div class="row">
										<div class="col-xl-3 col-lg-6">
                                            <div class="text-center">
                                                <h5 class="mb-0 text-primary">200 <small>Hours</small></h5>
                                                <div class="text-primary">Average Overtime</div>
                                            </div>
											<hr>
                                        </div>
										...
										<div class="col-xl-3 col-lg-6 mb-2">
											<div class="text-center">
												<h5 class="mb-0 text-primary">15 <small>Hours</small></h5>
                                                <div class="text-primary">Highest Overtime</div>
                                            </div>
											<hr>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6 mb-2">
                                             <div class="text-center">
                                                <h5 class="mb-0 text-primary">5</small></h5>
                                                <div class="text-primary">No. of Unusual Overtime</div>
                                            </div>
											<hr>
                                        </div>
										...
										<div class="col-xl-3 col-lg-6 mb-2">
											<div class="text-center">
                                                <h5 class="mb-0 text-primary">Juan Dela Cruz</small></h5>
                                                <div class="text-primary">Employee With Highest Ovetime</div>
                                            </div>                                          
											<hr>
                                        </div>	
                                    </div>
