...
<!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 d-none d-sm-inline-block">Mary Grace Branch</h1>
					</div>

                    <!-- DataTales Example -->

					<?php  
						if(isset($_GET["bcafe"]) == "bcafe")   
						{  
						?>
						
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="effect-shine nav-link active" href="branch.php?bcafe=bcafe" ><b>Cafe</b></a>
							</li>
							
							<li class="nav-item">
								<a class="effect-shine nav-link" href="branch.php?bkiosk=bkiosk"><b>Kiosk</b></a>
							</li>
						</ul>	
						
					<div class="card shadow mb-4"> 					
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between border-left-primary">
								<h6 class="m-0 font-weight-bold text-dark">Mary Grace Cafe</h6>   
							</div>
						...
						<div class="card-body border-left-primary">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover text-uppercase" id="example" width="100%" cellspacing="0">
									...
									<?php
										$sql = "SELECT * FROM user WHERE areatype in ('South','MFO','North')";
					...
					<?php  
						if(isset($_GET["bkiosk"]) == "bkiosk")   
						{  
						?>
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="effect-shine nav-link" href="branch.php?bcafe=bcafe" ><b>Cafe</b></a>
							</li>
							
							<li class="nav-item">
								<a class="effect-shine nav-link active" href="branch.php?bkiosk=bkiosk"><b>Kiosk</b></a>
							</li>
						</ul>
						
					<div class="card shadow mb-4">	
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between border-left-success">
                            <h6 class="m-0 font-weight-bold text-dark">Mary Grace Kiosk</h6>   
						</div>
						...
						<div class="card-body border-left-success">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover text-uppercase" id="example" width="100%" cellspacing="0">
									...
									<?php
										$sql = "SELECT * FROM user WHERE user_type = 'Kiosk' AND areatype = '' ";
										$query=$ORconnect->query($sql);
										while($row=$query->fetch_array())										
										{	
										?>		
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
		  ...
		  <h5 class="modal-title" id="exampleModalLabel"> <i class="fas fa-user-plus fa-fw"></i> Add Employee</h5>
			...
			<div class="form-group">
				<div class= "form-row">
					<div class="col-6">
						...
						<input type="number" min="1" class="form-control text-center text-uppercase" id="Employee" name="Employee" required />
					</div>
					...
					<label for="recipient-name" class="col-form-label">Department:</label>
						<select id="center" class="form-control" name="department" required>
                            <option></option>
                            <?php 
