...
header('Location:employeelist3.php?resigned=resigned');
...
<!-- Begin Page Content -->
				...
				<!-- Resigned -->        
				<?php  
					if(isset($_GET["resigned"]) == "resigned")   
					{  
					?>	
					<!-- DataTales Example -->
				...
				<ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="effect-shine nav-link active" href="employeelist3.php?resigned=resigned"><b>Resigned</b></a>
                            </li>
                        </ul>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered table-hover text-uppercase" id="example" width="100%" cellspacing="0">
									...
									<?php
										...
										$sql = "SELECT * FROM user_info where status = 'resigned'
