...
<body id="page-top" class="sidebar-toggled">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <div class="mb-3">
                <h4 class="mb-0 mr-3 font-weight-bold">Humility</h4>
            </div>
        </div>
        <!-- Datatable -->
...
<script>
    ...
    function redirectToHumilityList(id, responseName, evaluatedName, evaluatedPosition, evaluatedIdNumber) {
        ...
        window.location.href = `core-value-humility-list.php?id=${id}&response_name=${encodedResponseName}&evaluated_name=${encodedEvaluatedName}&evaluated_position=${encodedEvaluatedPosition}&evaluated_idnumber=${encodedEvaluatedIdNumber}`;
    }
</script>
